...
const swaggerJSON = `{
  ...
  "paths": {
    ...
    "/tasks/{id}/dispatch": { "post": { "summary": "一键派单（只占用空闲农机，推荐不可用时自动换台）", "tags": ["tasks"] } },
    "/tasks/{id}/reschedule": { "post": { "summary": "改期（先选好新的空闲农机再原子切换，可带 targetMachine/plannedWindow）", "tags": ["tasks"] } },
